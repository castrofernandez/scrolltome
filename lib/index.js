...
var scrolltome = {
  subscribe: function subscribe() {
    ...
    return _observer__WEBPACK_IMPORTED_MODULE_0__["default"].subscribe(data);
  }
};
...
/* harmony import */ var _seen_status__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./seen.status */ "./src/seen.status.js");
...
function () {
  function Observed() {
    ...
    var _options$element = options.element,
        ...
        repeat = _options$repeat === void 0 ? _repeat_options__WEBPACK_IMPORTED_MODULE_1__["default"].FIRST_IN : _options$repeat;
    this.valid = areOptionsValid(options) && _repeat_options__WEBPACK_IMPORTED_MODULE_1__["default"][repeat];
    ...
    this.status = new _seen_status__WEBPACK_IMPORTED_MODULE_2__["default"]();
  }
  ...
  _createClass(Observed, [{
    ...
    key: "check",
    value: function check(inViewPort, direction) {
      return this.checkEntering(inViewPort, direction) || this.checkLeaving(inViewPort, direction);
    }
  }, {
    key: "checkEntering",
    value: function checkEntering(inViewPort, direction) {
      return inViewPort && !this.inViewPort ? this.isEnteringInViewPort(direction) : false;
    }
  }, {
    key: "checkLeaving",
    value: function checkLeaving(inViewPort, direction) {
...
function () {
  ...
  _createClass(Observer, [{
    ...
    value: function subscribe() {
      var data = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var obs = new _observed__WEBPACK_IMPORTED_MODULE_0__["default"](data);
